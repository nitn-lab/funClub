...
const Login = () => {
  return (
    <div className="h-screen">
      ...
      />
      <div className="absolute top-0 flex p-20 w-full h-screen ">
        <div className=" flex items-center justify-center w-1/2 md:w-full backdrop-blur-lg">
          <LoginForm />
        </div>
        <div className="md:hidden relative flex  w-1/2 items-center bg-white/10   backdrop-blur-lg">
