          ...
          <div className="w-full items-center justify-center">
            ...
            {index === 0 && (
              <div className="flex justify-center">
                <button className="w-fit active:scale-[.98] acitve:duration-75 ease-in-out transition-all py-1 px-2 rounded-md text-lg font-semibold flex items-center justify-center gap-2 acitve:duration-75 hover:scale-[1.05] bg-primary-light dark:bg-primary-dark text-primary-dark dark:text-primary-light">
            ...
            <div className="flex absolute bottom-5 md:bottom-3 justify-between items-center w-[93.5%]">
              {index > 0 ? (
                <button
                  onClick={handleBack}
                  className="w-max active:scale-[.98] acitve:duration-75 hover:scale-[1.01] ease-in-out transition-all py-1 px-2 rounded-md text-lg font-bold flex items-center justify-between gap-2 bg-primary-light dark:bg-primary-dark text-primary-dark dark:text-primary-light"
                >
                  <IoIosArrowBack />
                  Back
                </button>
              ...
              <button
                ...
                className="w-max active:scale-[.98] acitve:duration-75 hover:scale-[1.01] ease-in-out transition-all py-1 px-2 rounded-md  bg-primary-light dark:bg-primary-dark text-primary-dark dark:text-primary-light text-lg font-bold flex items-center justify-between gap-2 xxs:right-1"
              >
                {loading ? (
