          ...
          <div className="w-full items-center justify-center">
            ...
            {index === 0 && (
              <div className="flex justify-center">
                <button className="w-fit active:scale-[.98] acitve:duration-75 ease-in-out transition-all py-1 px-2 rounded-md text-lg font-semibold flex items-center justify-center gap-2 acitve:duration-75 hover:scale-[1.05] bg-primary-dark text-primary-light">
