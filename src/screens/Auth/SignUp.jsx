...
const Register = () => {
  ...
  return (
    <div className="flex w-full h-screen p-8 justify-center bg-gradient-to-tr from-violet-500 to-pink-500">
      ...
      <div className="w-1/2 bg-black opacity-[0.9] px-8 relative rounded-r-lg">
        <div className="flex">
          <div className="w-full items-center justify-center">
            ...
            {index === 0 && (
              <div className="">
                <button className="w-full  active:scale-[.98] acitve:duration-75  ease-in-out transition-all py-2 px-6 rounded-xl   text-lg font-semibold flex  items-center justify-center gap-2 acitve:duration-75 hover:scale-[1.05] bg-white">
            ...
            <div
              ...
              className="flex absolute bottom-10 justify-between w-[90%]"
            >
              {index > 0 ? (
                <button
                  onClick={handleBack}
