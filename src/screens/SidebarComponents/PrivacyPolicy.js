...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="mx-auto p-4 md:p-6 lg:p-8 h-[100vh] bg-black scrollable-div overflow-y-auto text-white font-gotham w-full">
           ...
           <h1 className="text-3xl font-normal mb-2">Privacy Policy</h1>
            ...
            <div id="introduction" className="mb-4 px-8">
            ...
            <div id="personal-data" className="mb-4 px-8">
            ...
            <div id="changes" className="mb-4 px-8">
            ...
            <div id="applicability" className="mb-4 px-8">
            ...
            <div id="third-party-links" className="mb-4 px-8">
